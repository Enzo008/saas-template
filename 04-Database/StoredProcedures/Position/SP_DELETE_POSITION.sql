...
BEGIN TRY
    ...
    BEGIN
       SET @P_MESSAGE_DESCRIPTION  = 'The position you are trying to delete does not exist'
    ...
    SET @P_MESSAGE_DESCRIPTION  = 'Position deleted successfully'
