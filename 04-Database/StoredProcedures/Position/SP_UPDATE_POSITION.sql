...
BEGIN TRY
    ...
    BEGIN
       SET @P_MESSAGE_DESCRIPTION  = 'Another position with the same name already exists'
    ...
    SET @V_DESCRIPTION_LOG = 'UPDATED ' + @V_CADENA + ' TO ' + @V_CADENA_MODIFICADO
    SET @V_CODE_COMPLETE = LTRIM(RTRIM(UPPER(@P_POSCOD)))
    ...
    SET @P_MESSAGE_DESCRIPTION  = 'Position updated successfully'
