...
BEGIN TRY
    ...
    BEGIN
       SET @P_MESSAGE_DESCRIPTION  = 'The identity document you are trying to delete does not exist'
    ...
    SET @P_MESSAGE_DESCRIPTION  = 'Identity document deleted successfully.'
