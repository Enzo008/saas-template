...
BEGIN TRY
    ...
    DECLARE @V_NOMBRE_TABLA      NVARCHAR(300)  = 'TM_MENU, TB_PERMISSION',
            @V_CODIGO_LOG_ANIO   CHAR(4)        = '',
            @V_CODIGO_LOG        CHAR(10)       = '',
            @V_DESCRIPCION_LOG   NVARCHAR(300)  = '',
            @V_ERROR             NVARCHAR(MAX)  = ''

    SET @V_DESCRIPCION_LOG = 'GOT ALL MENUS AND PERMISSIONS WITH ASSIGNMENT STATUS'
    ...
    SET @P_DESCRIPCION_MENSAJE = 'Menus and permissions retrieved successfully'
...
BEGIN CATCH
    ...
    EXEC SP_REGISTRAR_LOG @V_ERROR,'GET',@P_LOGIPMAQ,'',@V_NOMBRE_TABLA,'SP_GET_ALL_MENUS_PERMISSIONS','ERROR',@P_USEYEA_U,@P_USECOD_U,@P_USENAM_U,@P_USELAS_U,@P_DESCRIPCION_MENSAJE = @P_DESCRIPCION_MENSAJE OUTPUT,@P_TIPO_MENSAJE = @P_TIPO_MENSAJE OUTPUT,@P_LOGANO = @V_CODIGO_LOG_ANIO OUTPUT,@P_LOGCOD = @V_CODIGO_LOG OUTPUT
    EXEC SP_ACTUALIZA_FECHA_FIN_Y_SQL @V_CODIGO_LOG_ANIO, @V_CODIGO_LOG, 'SP_GET_ALL_MENUS_PERMISSIONS'
