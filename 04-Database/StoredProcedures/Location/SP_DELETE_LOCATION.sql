...
BEGIN TRY
    ...
    BEGIN
       SET @P_MESSAGE_DESCRIPTION  = 'The location you are trying to delete does not exist'
    ...
    IF @V_CANTIDAD_REGISTRO > 0
    BEGIN
       SET @P_MESSAGE_DESCRIPTION  = 'Cannot delete location because it has child locations associated'
       SET @P_MESSAGE_TYPE         = '2'
       RETURN
    END
    ...
    SET @P_MESSAGE_DESCRIPTION  = 'Location deleted successfully'
